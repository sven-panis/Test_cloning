...
# all same except se_survival ... !!!!!! TODO: check formulas...
...
# error: wrong colors for median-segments in plots ??? SOLVED by changing condition values 0,1,2 to 1,2,3 !!!
# error: different colors between subplots ??    SOLVED by changing condition values 0,1,2 to 1,2,3 !!!
```
