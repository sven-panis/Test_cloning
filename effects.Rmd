...
b2.linear <- readRDS("models/b2.linear")
b2.cubic <- readRDS("models/b2.cubic")
b2.factor <- readRDS("models/b2.factor")
b2.general <- readRDS("models/b2.general")

b4_general_nointeractions <- readRDS("models/b4_general_nointeractions")
b4_general_interactions2 <- readRDS("models/b4_general_interactions2")
b4_general_interactions_nonlinear2 <- readRDS("models/b4_general_interactions_nonlinear2")
b4_general_interactions_nonlinear_noprop3 <- readRDS("models/b4_general_interactions_nonlinear_noprop3")

#b5_multilevel_1 <- readRDS("models/b5_multilevel_1")
